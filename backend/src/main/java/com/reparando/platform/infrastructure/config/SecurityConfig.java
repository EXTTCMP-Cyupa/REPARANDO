    ...
    public SecurityWebFilterChain springSecurityFilterChain(
        ...
        return http
            ...
            .authorizeExchange(exchange -> exchange
                ...
                .pathMatchers(HttpMethod.POST, "/api/v1/finance/lead/charge").hasRole("ADMIN")
                ...
                .pathMatchers(HttpMethod.POST, "/api/v1/finance/ledger/adjustments").hasRole("ADMIN")
                .pathMatchers(HttpMethod.POST, "/api/v1/finance/ledger/*/refund").hasRole("ADMIN")
